...
plt.savefig("data/smc_premotor_pid/cartpole/cartpole_affordance_all_neighbor_returns.png")

filehandler = open("data/smc_premotor_pid/cartpole/affordance_all_neighbor_wsm.obj", 'wb')
